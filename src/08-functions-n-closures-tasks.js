...
function getPolynom(...arg) {
  const arg3 = arg[arguments.length - 1] || 0;
  const arg2 = arg[arguments.length - 2] || 0;
  const arg1 = arg[arguments.length - 3] || 0;
  return function polynom(x) {
    return arg1 * x ** 2 + arg2 * x + arg3;
  };
}
